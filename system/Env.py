...
class Env:
    ...
    def check_env_existence(self, envs: list) -> None:
        ...
        if len(missing_envs) > 0:
            ...
            self.cli.print((self.cli.color.clear + ", " + self.cli.color.cyan).join(missing_envs), self.cli.color.cyan)
            self.cli.print_ln(f" are {self.cli.color.red}missing{self.cli.color.clear} from {self.cli.color.cyan}.env{self.cli.color.clear} file.")
            self.app.terminate()
